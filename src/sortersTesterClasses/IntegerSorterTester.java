...
public class IntegerSorterTester {
	...
	public static void main(String[] args) { 
		...
		test2("Sorting Using Default Comparator<Integer>", null); 
	}
	...
	//////////////////////////////////////////////////////////////////////////////
	//Tester for array of type Entero[]
	private static void test2(String msg, Comparator<Entero> cmp) { 
		...
		// generate random arrays is size i and test...
		for (int i=1; i<=20; i += 5) { 
			original = randomValores(i);
			showEnteroArray("\n ---Original array of size " + i + " to sort:", original); 
			
			for (int s=0; s<sortersList2.size(); s++) {
	...
	private static Entero[] randomValores(int i) {
